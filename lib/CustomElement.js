...
function makeMakeClass() {
  try {
    return new Function('config', [
      ...
      "    if (typeof onAttributeChange === 'function') return onAttributeChange.apply(this, arguments)",
      "  }",
      "  connectedCallback() {",
      "    if (typeof onConnect === 'function') return onConnect.call(this)",
      "  }",
      "  disconnectedCallback() {",
      "    if (typeof onDisconnect === 'function') return onDisconnect.call(this)",
      "  }",
      "}",
    ].join("\n"))
  } catch (e) {
    return function (config) {
      ...
      CustomElementConstructor.prototype.connectedCallback = onConnect
      CustomElementConstructor.prototype.disconnectedCallback = onDisconnect
      CustomElementConstructor.prototype.attributeChangedCallback = onAttributeChange
