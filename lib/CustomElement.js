 ...
 * @param {Object<string, Object>} config.properties Getters, setters and defaults for properties on the custom element that can be accessed and set with `Html.Attributes.property`. These should map a property name onto a `get` function that returns a value and a `set` function that applies a value from the only argument.
...
exports.create = function create(config) {
  ...
  Class.__METHOD_NAMES__ = Object.keys(methods)
