...
practice =
    Nri.Ui.Svg.V1.init "0 0 46 46"
        [ Svg.g [ Attributes.clipPath "url(#clip0_10_2875)" ]
            [ Svg.path
...
guidedDraft =
    Nri.Ui.Svg.V1.init "0 0 50 50"
        [ Svg.path
            ...
            []
        , Svg.path
            [ Attributes.d "M45.8333 21.875V20.2448C45.8333 16.2039 45.8333 14.1835 44.6129 12.9281C43.3925 11.6728 41.4283 11.6728 37.5 11.6728H33.1695C31.2583 11.6728 31.2425 11.6691 29.5239 10.809L22.5831 7.3357C19.685 5.88549 18.236 5.16039 16.6924 5.21079C15.1488 5.26118 13.7474 6.07933 10.9446 7.71564L8.38658 9.2091C6.32786 10.411 5.29848 11.012 4.73254 12.0117C4.16663 13.0115 4.16663 14.229 4.16663 16.664V33.7827C4.16663 36.9821 4.16663 38.5819 4.87967 39.4723C5.35415 40.0646 6.01904 40.4629 6.75413 40.595C7.85883 40.7933 9.21138 40.0037 11.9164 38.4244C13.7532 37.3521 15.521 36.2383 17.7184 36.5404C19.5597 36.7933 21.2708 37.9552 22.9166 38.7787"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "3"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
...
standards =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.path
            ...
            []
        , Svg.g [ Attributes.clipPath "url(#clip0_1057_151)" ]
            [ Svg.path
...
modules =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.path
            ...
            []
        , Svg.g [ Attributes.clipPath "url(#clip0_1057_161)" ]
            [ Svg.path
...
passageQuizCircled =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.path
            ...
            []
        , Svg.path
            [ Attributes.d "M31.875 26.6667H48.5417M31.875 35H37.0833M48.5417 35H43.3333M31.875 43.3333H37.0833M48.5417 43.3333H43.3333"
            , Attributes.stroke "white"
            , Attributes.strokeWidth "4"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M24.5833 25.625H22.5C18.5716 25.625 16.6074 25.625 15.387 26.8454C14.1666 28.0658 14.1666 30.03 14.1666 33.9583V47.5C14.1666 50.3765 16.4985 52.7083 19.375 52.7083C22.2514 52.7083 24.5833 50.3765 24.5833 47.5V25.625Z"
            , Attributes.stroke "white"
            , Attributes.strokeWidth "4"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M43.3333 17.2917H32.9167C30.9792 17.2917 30.0105 17.2917 29.2157 17.5046C27.0589 18.0825 25.3742 19.7672 24.7963 21.924C24.5833 22.7188 24.5833 23.6876 24.5833 25.625V47.5C24.5833 50.3765 22.2515 52.7083 19.375 52.7083H43.3333C49.2258 52.7083 52.1721 52.7083 54.0027 50.8777C55.8333 49.0471 55.8333 46.1008 55.8333 40.2083V29.7917C55.8333 23.8991 55.8333 20.9528 54.0027 19.1223C52.1721 17.2917 49.2258 17.2917 43.3333 17.2917Z"
            , Attributes.stroke "white"
            , Attributes.strokeWidth "4"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
...
planningDiagnosticCircled =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.path
            ...
            []
        , Svg.path
            [ Attributes.d "M35.0485 23.4568L35.0491 23.4561C35.1882 23.2892 35.2613 23.1034 35.2999 22.8464C35.3369 22.6005 35.3446 22.2723 35.3446 21.811L35.3445 20.0001C35.3445 18.4813 36.5757 17.25 38.0945 17.25H48.9979C50.5167 17.25 51.7479 18.4812 51.7479 20V30.907C51.7479 32.4258 50.5167 33.657 48.9979 33.657H47.9049C47.6029 33.657 47.4634 33.6409 47.3981 33.6223C47.3967 33.6219 47.3954 33.6215 47.3942 33.6212C47.3912 33.6069 47.3885 33.5813 47.3914 33.5355C47.3957 33.4672 47.4097 33.3828 47.4303 33.2587C47.4707 33.0165 47.526 32.6797 47.526 32.2117C47.526 31.1421 46.9837 30.2299 46.2263 29.5918C45.4708 28.9554 44.4825 28.5745 43.5471 28.5745C42.6074 28.5745 41.6182 28.977 40.8641 29.6218C40.1092 30.2674 39.5647 31.1787 39.5647 32.2117C39.5647 32.6805 39.6201 33.0177 39.6604 33.26C39.6811 33.3842 39.695 33.4684 39.6993 33.5365C39.7023 33.5829 39.6995 33.6083 39.6964 33.6219C39.6954 33.6222 39.6943 33.6225 39.6932 33.6229C39.6281 33.6413 39.4891 33.657 39.1875 33.657H38.0928C36.5741 33.657 35.3428 32.4258 35.3428 30.907V29.0963C35.3428 28.6342 35.3352 28.3059 35.2982 28.0602C35.2595 27.8033 35.1864 27.618 35.0474 27.4512L35.0468 27.4505C34.8948 27.2694 34.7073 27.1974 34.502 27.2057C34.3237 27.213 34.1364 27.2816 33.9676 27.346C33.9425 27.3556 33.9171 27.3654 33.8914 27.3753C33.5521 27.506 33.1604 27.6569 32.6405 27.6569C31.4251 27.6569 30.4381 26.67 30.4381 25.4528C30.4381 24.2374 31.4249 23.2504 32.6422 23.2504C33.1611 23.2504 33.5525 23.4011 33.892 23.5318C33.9179 23.5418 33.9434 23.5516 33.9687 23.5613C34.1377 23.6257 34.3251 23.6943 34.5035 23.7015C34.7088 23.7098 34.8965 23.6379 35.0485 23.4568Z"
            , Attributes.fill "white"
            , Attributes.stroke "currentColor"
            ...
            []
        , Svg.path
            [ Attributes.d "M21.8109 33.9055C22.7389 33.9055 23.0482 33.938 23.296 34.1431C23.7745 34.5447 23.0003 35.1343 23.0003 36.3579C23.0003 37.7131 24.0992 38.812 25.4527 38.812C26.8079 38.812 27.9051 37.7131 27.9051 36.3596C27.9051 35.1343 27.1309 34.5464 27.6094 34.1448C27.8555 33.9397 28.1648 33.9073 29.0945 33.9073H33.9052V33.9073C33.9042 33.9073 33.9035 33.9065 33.9035 33.9055L33.9052 29.8126C33.9052 29.2127 33.8471 29.1273 33.7309 29.0777C33.4933 28.9752 33.1054 29.1854 32.2099 29.1854C30.3266 29.1854 28.8227 27.1978 28.8227 25.453C28.8227 23.7099 30.2497 21.7241 32.2099 21.7241C33.1037 21.7241 33.4916 21.9343 33.7309 21.8317C33.8454 21.7822 33.9052 21.6967 33.9052 21.0952L33.9047 19.9992C33.904 18.3429 32.5611 17.0005 30.9047 17.0005H20C18.3431 17.0005 17 18.3436 17 20.0005V30.9056C17 32.5625 18.3432 33.9057 20.0001 33.9056L21.8109 33.9055Z"
            , Attributes.fill "white"
            ]
            []
        , Svg.path
            [ Attributes.d "M29.8107 35.4543L33.6553 35.4559L33.6537 40.0166V40.0167C33.6537 40.4788 33.6614 40.807 33.6984 41.0527C33.737 41.3097 33.8102 41.495 33.9492 41.6618L33.9498 41.6624C34.1018 41.8436 34.2895 41.9155 34.4948 41.9072C34.6732 41.9 34.8607 41.8314 35.0297 41.7669C35.0549 41.7573 35.0804 41.7475 35.1062 41.7376C35.446 41.6069 35.8379 41.4561 36.3578 41.4561C37.5733 41.4561 38.5602 42.4414 38.5602 43.6585C38.5602 44.874 37.5748 45.8608 36.3578 45.8608C35.8387 45.8608 35.4471 45.7096 35.1075 45.5785C35.0819 45.5686 35.0566 45.5588 35.0315 45.5492C34.8626 45.4846 34.6751 45.4157 34.4968 45.4083C34.2914 45.3997 34.1036 45.4715 33.9515 45.6527L33.9504 45.6541C33.8118 45.8215 33.7387 46.0068 33.7001 46.2637C33.6631 46.5095 33.6554 46.8373 33.6554 47.2985L33.6555 49.1093C33.6555 50.6282 32.4243 51.8594 30.9055 51.8594H20.0004C18.4816 51.8594 17.2504 50.6282 17.2504 49.1094V38.206C17.2504 36.6872 18.4816 35.456 20.0004 35.456H21.0933C21.3956 35.456 21.5354 35.4716 21.6011 35.49C21.6022 35.4903 21.6032 35.4906 21.6042 35.4909C21.6072 35.5053 21.6097 35.5309 21.6068 35.5758C21.6025 35.6441 21.5886 35.7284 21.5679 35.8526C21.5276 36.0947 21.4722 36.4315 21.4722 36.8996C21.4722 37.9692 22.0145 38.8813 22.772 39.5194C23.5275 40.1559 24.5157 40.5367 25.4512 40.5367C26.3908 40.5367 27.38 40.1347 28.1341 39.4901C28.8891 38.8446 29.4335 37.9334 29.4335 36.8996C29.4335 36.4315 29.3782 36.0947 29.3379 35.8525C29.3172 35.7284 29.3032 35.6441 29.2989 35.5758C29.296 35.5291 29.2988 35.5034 29.3019 35.4893C29.3029 35.489 29.304 35.4887 29.3051 35.4884C29.3702 35.4699 29.5092 35.4543 29.8106 35.4543C29.8107 35.4543 29.8107 35.4543 29.8107 35.4543Z"
            , Attributes.fill "white"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "0.5"
            ]
            []
        , Svg.path
            [ Attributes.d "M47.1891 35.204C46.2611 35.204 45.9518 35.1732 45.704 34.9664C45.2255 34.5648 45.9997 33.9753 45.9997 32.7516C45.9997 31.3964 44.9008 30.2975 43.5473 30.2975C42.1921 30.2975 41.0949 31.3964 41.0949 32.7499C41.0949 33.9753 41.8691 34.5631 41.3906 34.9647C41.1445 35.1715 40.8352 35.2023 39.9055 35.2023L35.0966 35.204L35.0948 39.2987C35.0948 39.8985 35.153 39.9823 35.2692 40.0335C35.5067 40.1361 35.8947 39.9259 36.7902 39.9259C38.6734 39.9259 40.1773 41.9134 40.1773 43.6582C40.1773 45.4014 38.7504 47.3872 36.7902 47.3872C35.8964 47.3872 35.5084 47.177 35.2692 47.2795C35.1547 47.3291 35.0948 47.4145 35.0948 48.0161L35.0953 49.1103C35.096 50.7667 36.4389 52.1091 38.0953 52.1091H49C50.6569 52.1091 52 50.7659 52 49.1091V38.2039C52 36.547 50.6568 35.2039 48.9999 35.2039L47.1891 35.204Z"
            , Attributes.fill "white"
            ]
            []
        ]
...
guidedDraftCircled =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.path
            ...
            []
        , Svg.path
            [ Attributes.d "M46.3825 38.757C46.8793 38.2187 47.1276 37.9497 47.3916 37.7927C48.0285 37.4138 48.8126 37.402 49.4601 37.7615C49.7286 37.9105 49.9846 38.172 50.4966 38.6952C51.0088 39.2183 51.2648 39.4798 51.4106 39.754C51.7625 40.4153 51.751 41.2165 51.3801 41.8672C51.2265 42.1368 50.9631 42.3905 50.4361 42.898L44.1671 48.9362C43.1686 49.8978 42.6693 50.3788 42.0453 50.6225C41.4213 50.8662 40.7355 50.8483 39.3635 50.8123L39.177 50.8075C38.7593 50.7967 38.5505 50.7912 38.429 50.6533C38.3076 50.5157 38.3241 50.3028 38.3573 49.8775L38.3753 49.6465C38.4686 48.449 38.5153 47.8503 38.7491 47.3122C38.983 46.774 39.3863 46.337 40.193 45.463L46.3825 38.757Z"
            , Attributes.stroke "white"
            , Attributes.strokeWidth "3"
            , Attributes.strokeLinejoin "round"
            , Attributes.fill "none"
            ...
            []
        , Svg.path
            [ Attributes.d "M51.6667 32.5V31.1958C51.6667 27.9631 51.6667 26.3468 50.6904 25.3425C49.714 24.3382 48.1427 24.3382 45 24.3382H41.5357C40.0067 24.3382 39.994 24.3353 38.6192 23.6472L33.0665 20.8686C30.7481 19.7084 29.5889 19.1283 28.354 19.1686C27.1191 19.209 25.998 19.8635 23.7558 21.1725L21.7093 22.3673C20.0624 23.3288 19.2389 23.8096 18.7861 24.6094C18.3334 25.4092 18.3334 26.3832 18.3334 28.3312V42.0262C18.3334 44.5857 18.3334 45.8655 18.9038 46.5778C19.2834 47.0517 19.8153 47.3703 20.4034 47.476C21.2871 47.6347 22.3692 47.003 24.5332 45.7395C26.0026 44.8817 27.4169 43.9907 29.1748 44.2323C30.6479 44.4347 32.0167 45.3642 33.3334 46.023"
            , Attributes.stroke "white"
            , Attributes.strokeWidth "3"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M28.3334 19.1667V44.1667"
            , Attributes.stroke "white"
            , Attributes.strokeWidth "3"
            , Attributes.strokeLinejoin "round"
            , Attributes.fill "none"
...
peerReviewCircled =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.path
            ...
            []
        , Svg.g [ Attributes.clipPath "url(#clip0_10_3116)" ]
            [ Svg.path
...
gradingAssistantCircled =
    let
        toIcon circle =
            [ circle
            , Svg.path
                [ Attributes.d "M49.1972 21.7474C49.0028 21.5517 48.7139 21.4835 48.4505 21.5679L41.6733 23.8262L35.9479 19.5932V19.595C35.7262 19.4317 35.4301 19.4065 35.183 19.5304C34.9377 19.6543 34.7833 19.9056 34.7851 20.1785L34.865 27.2405L29.0163 31.3155C28.791 31.4734 28.6766 31.7445 28.7202 32.0138C28.7638 32.2812 28.9582 32.5038 29.2198 32.5846L36.0425 34.6921L38.1557 41.4435V41.4452C38.2392 41.7073 38.4627 41.8994 38.7371 41.9425C39.0096 41.9838 39.284 41.8707 39.4439 41.6463L43.5865 35.8839L50.7362 35.988C51.0124 35.9916 51.2667 35.839 51.3921 35.5949C51.5175 35.3507 51.4921 35.0581 51.3267 34.8391L47.0623 29.1664L49.3717 22.4812C49.4589 22.2245 49.3917 21.9395 49.1972 21.7474ZM34.8504 35.8807C34.7668 35.7981 34.6651 35.7371 34.5524 35.7029L32.3521 35.0208C32.0941 34.94 31.8106 35.0082 31.6199 35.1967L18.7484 47.9136C17.691 48.9583 17.6783 50.6709 18.7339 51.7139C19.7896 52.7568 21.523 52.7425 22.5804 51.6977L35.4899 38.9432V38.945C35.6807 38.7565 35.7498 38.48 35.6716 38.2251L35.0321 36.1751H35.0303C34.9957 36.0638 34.934 35.9632 34.8504 35.8807Z"
                , Attributes.fill "white"
                ]
                []
            ]
