module Nri.Ui.AssignmentIcon.V2 exposing
    ...
    , quickWrite, guidedDraft, guidedEssay, guidedShortResponse, peerReview, selfReview, dailyWriting, novels, texts, genres, genresCircled, readWriteReason, readWriteReasonCircled
...
@docs quickWrite, guidedDraft, guidedEssay, guidedShortResponse, peerReview, selfReview, dailyWriting, novels, texts, genres, genresCircled, readWriteReason, readWriteReasonCircled
...
{-| -}
readWriteReason : Nri.Ui.Svg.V1.Svg
readWriteReason =
    Nri.Ui.Svg.V1.init "0 0 50 50"
        [ Svg.path
            [ Attributes.d "M25.001 4C21.2201 4 18.0635 6.67071 17.3135 10.2285C15.9317 9.01963 14.1237 8.28613 12.1436 8.28613C7.80437 8.28617 4.28634 11.8033 4.28613 16.1426C4.28613 18.123 5.02145 19.9306 6.23047 21.3125C2.67225 22.062 0.00112629 25.2187 0.000976562 29C0.000976562 33.201 3.29778 36.6321 7.44531 36.8467C7.25057 37.5312 7.1436 38.253 7.14355 39C7.14355 43.3395 10.6616 46.8574 15.001 46.8574C15.031 46.8574 15.0609 46.8548 15.0908 46.8545C15.0344 46.7179 15.0013 46.5683 15 46.4111V33.2461C14.9998 31.8457 15.0006 30.7839 15.0889 29.8672C15.1146 29.5986 15.1477 29.3441 15.1904 29.0986C15.1915 29.0929 15.1923 29.0868 15.1934 29.0811C15.2411 28.8086 15.3006 28.5451 15.375 28.2842C15.7509 26.9679 16.4753 25.8173 17.6621 23.9307L21.8809 17.2217C22.4187 16.3665 22.8901 15.6171 23.3369 15.0928C23.8067 14.5417 24.4467 14 25.3574 14C26.2682 14 26.9083 14.5417 27.3779 15.0928C27.8249 15.6171 28.2963 16.3664 28.834 17.2217L33.0527 23.9307C34.2395 25.8173 34.9639 26.9679 35.3398 28.2842C35.4141 28.5442 35.4737 28.8067 35.5215 29.0781C35.5227 29.0847 35.5233 29.0921 35.5244 29.0986C35.57 29.3601 35.6055 29.6318 35.6318 29.9199C35.7127 30.7983 35.7149 31.8121 35.7148 33.1279V46.4014C35.7148 46.5527 35.6861 46.6973 35.6348 46.8301C39.6775 46.5071 42.8574 43.1259 42.8574 39C42.8574 38.2531 42.7514 37.5311 42.5566 36.8467C46.7039 36.6318 50 33.2008 50 29C49.9999 25.219 47.3294 22.0623 43.7715 21.3125C44.9803 19.9307 45.7148 18.1228 45.7148 16.1426C45.7146 11.8033 42.1966 8.28613 37.8574 8.28613C35.8775 8.2862 34.0702 9.01987 32.6885 10.2285C31.9385 6.67075 28.7818 4.00015 25.001 4ZM22.6406 21.0264C22.379 21.0264 22.1351 21.1625 21.9941 21.3867L19.6973 25.0391C18.5112 26.9252 17.9677 27.8069 17.6729 28.6621L17.7451 28.6982C18.066 28.858 18.3817 29.0115 18.6982 29.1494C19.3464 29.4315 19.9066 29.6021 20.3809 29.6152C21.0327 29.6333 21.5996 29.4079 22.4033 29.0566L22.4951 29.0166C22.6851 28.9333 22.8909 28.8434 23.1104 28.7559C23.5734 28.5711 23.805 28.4788 24.0059 28.6182C24.2066 28.7576 24.207 29.0302 24.207 29.5752V41.8369C24.4699 41.85 24.7348 41.8574 25.001 41.8574C25.5093 41.8574 26.0119 41.8324 26.5078 41.7852V29.5752C26.5078 29.0303 26.5084 28.7577 26.709 28.6182C26.9098 28.4787 27.1422 28.571 27.6055 28.7559C27.825 28.8434 28.0306 28.9333 28.2207 29.0166L28.3115 29.0566C29.1151 29.4079 29.6822 29.6333 30.334 29.6152C30.8083 29.6021 31.3694 29.4316 32.0176 29.1494C32.3339 29.0116 32.6491 28.8579 32.9697 28.6982L33.043 28.6621C32.7481 27.8068 32.2037 26.9252 31.0176 25.0391L28.7207 21.3867C28.5797 21.1625 28.3358 21.0264 28.0742 21.0264H22.6406Z"
            , Attributes.fill "currentColor"
            ]
            []
        ]
...
{-| -}
readWriteReasonCircled : Nri.Ui.Svg.V1.Svg
readWriteReasonCircled =
    Nri.Ui.Svg.V1.init "0 0 70 70"
        [ Svg.circle
            [ Attributes.cx "35"
            , Attributes.cy "35"
            ...
            []
        , Svg.path
            [ Attributes.d "M35 18C31.9756 18 29.4508 20.1366 28.8506 22.9824C27.7453 22.0155 26.2988 21.4288 24.7148 21.4287C21.2434 21.4287 18.4287 24.2433 18.4287 27.7148C18.4288 29.2992 19.017 30.7451 19.9844 31.8506C17.1377 32.4501 15.0002 34.975 15 38C15 41.3609 17.6379 44.1058 20.9561 44.2773C20.8002 44.825 20.7149 45.4024 20.7148 46C20.7148 49.4715 23.5286 52.286 27 52.2861C27.0241 52.2861 27.0483 52.2844 27.0723 52.2842C27.027 52.1748 27.0011 52.0546 27 51.9287V41.3965C26.9999 40.2762 26.9997 39.4267 27.0703 38.6934C27.0909 38.4787 27.1172 38.2753 27.1514 38.0791C27.1522 38.0745 27.1534 38.0691 27.1543 38.0645C27.1924 37.8467 27.2403 37.6362 27.2998 37.4277C27.6005 36.3747 28.1794 35.4537 29.1289 33.9443L32.5039 28.5771C32.9341 27.893 33.3115 27.2934 33.6689 26.874C34.0447 26.4333 34.5568 26.0002 35.2852 26C36.0138 26 36.5266 26.4332 36.9023 26.874C37.2599 27.2934 37.6363 27.893 38.0664 28.5771L41.4424 33.9443C42.3918 35.4536 42.9707 36.3747 43.2715 37.4277C43.3308 37.6356 43.3788 37.8455 43.417 38.0625C43.418 38.0677 43.418 38.0739 43.4189 38.0791C43.4555 38.2883 43.4838 38.5058 43.5049 38.7363C43.5696 39.4391 43.5714 40.25 43.5713 41.3027V51.9209C43.5713 52.042 43.5479 52.1575 43.5068 52.2637C46.7412 52.0055 49.2861 49.3009 49.2861 46C49.2861 45.4025 49.2007 44.8249 49.0449 44.2773C52.3627 44.1054 55 41.3606 55 38C54.9998 34.9756 52.8634 32.4507 50.0176 31.8506C50.9845 30.7452 51.5712 29.2988 51.5713 27.7148C51.5713 24.2434 48.7574 21.4289 45.2861 21.4287C43.7023 21.4287 42.2557 22.0157 41.1504 22.9824C40.5502 20.1365 38.0245 18 35 18ZM33.1123 31.6211C32.903 31.6211 32.7075 31.7298 32.5947 31.9092L30.7578 34.8311C29.8089 36.34 29.3736 37.0453 29.1377 37.7295L29.1953 37.7588C29.452 37.8866 29.7048 38.0098 29.958 38.1201C30.4765 38.3458 30.9253 38.4817 31.3047 38.4922C31.8259 38.5066 32.2792 38.3268 32.9219 38.0459L32.9951 38.0137C33.1471 37.947 33.3117 37.8747 33.4873 37.8047C33.8579 37.6568 34.0434 37.5828 34.2041 37.6943C34.3649 37.8058 34.3652 38.0239 34.3652 38.46V48.2695C34.5755 48.28 34.7871 48.2861 35 48.2861C35.4068 48.2861 35.8091 48.2653 36.2061 48.2275V38.46C36.2061 38.0239 36.2064 37.8058 36.3672 37.6943C36.5278 37.5829 36.7135 37.6568 37.084 37.8047C37.2596 37.8747 37.4241 37.947 37.5762 38.0137L37.6494 38.0459C38.292 38.3268 38.7453 38.5066 39.2666 38.4922C39.646 38.4817 40.0947 38.3458 40.6133 38.1201C40.8664 38.0099 41.1185 37.8865 41.375 37.7588L41.4336 37.7295C41.1977 37.0453 40.7624 36.34 39.8135 34.8311L37.9766 31.9092C37.8637 31.7298 37.6683 31.6211 37.459 31.6211H33.1123Z"
            , Attributes.fill "white"
            ]
            []
        ]
