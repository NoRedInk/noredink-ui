module Nri.Ui.UiIcon.V2 exposing
    ...
    , activity
    , footsteps, footstepsVideo, compass, help, checklist, review, bookSearch
...
@docs activity
@docs footsteps, footstepsVideo, compass, help, checklist, review, bookSearch
...
performance =
    Nri.Ui.Svg.V1.init "0 0 22 22"
        [ Svg.path
            [ Attributes.d "M2.5 11.5V18.5C2.5 18.9659 2.5 19.1989 2.57612 19.3827C2.67761 19.6277 2.87229 19.8224 3.11732 19.9239C3.30109 20 3.53406 20 4 20C4.46594 20 4.69891 20 4.88268 19.9239C5.12771 19.8224 5.32239 19.6277 5.42388 19.3827C5.5 19.1989 5.5 18.9659 5.5 18.5V11.5C5.5 11.0341 5.5 10.8011 5.42388 10.6173C5.32239 10.3723 5.12771 10.1776 4.88268 10.0761C4.69891 10 4.46594 10 4 10C3.53406 10 3.30109 10 3.11732 10.0761C2.87229 10.1776 2.67761 10.3723 2.57612 10.6173C2.5 10.8011 2.5 11.0341 2.5 11.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            ...
            []
        , Svg.path
            [ Attributes.d "M9.5 13.5V18.4995C9.5 18.9654 9.5 19.1984 9.5761 19.3822C9.6776 19.6272 9.8723 19.8219 10.1173 19.9234C10.3011 19.9995 10.5341 19.9995 11 19.9995C11.4659 19.9995 11.6989 19.9995 11.8827 19.9234C12.1277 19.8219 12.3224 19.6272 12.4239 19.3822C12.5 19.1984 12.5 18.9654 12.5 18.4995V13.5C12.5 13.0341 12.5 12.8011 12.4239 12.6173C12.3224 12.3723 12.1277 12.1776 11.8827 12.0761C11.6989 12 11.4659 12 11 12C10.5341 12 10.3011 12 10.1173 12.0761C9.8723 12.1776 9.6776 12.3723 9.5761 12.6173C9.5 12.8011 9.5 13.0341 9.5 13.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.strokeLinecap "square"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M16.5 9.5V18.5C16.5 18.9659 16.5 19.1989 16.5761 19.3827C16.6776 19.6277 16.8723 19.8224 17.1173 19.9239C17.3011 20 17.5341 20 18 20C18.4659 20 18.6989 20 18.8827 19.9239C19.1277 19.8224 19.3224 19.6277 19.4239 19.3827C19.5 19.1989 19.5 18.9659 19.5 18.5V9.5C19.5 9.0341 19.5 8.80109 19.4239 8.61732C19.3224 8.37229 19.1277 8.17761 18.8827 8.07612C18.6989 8 18.4659 8 18 8C17.5341 8 17.3011 8 17.1173 8.07612C16.8723 8.17761 16.6776 8.37229 16.5761 8.61732C16.5 8.80109 16.5 9.0341 16.5 9.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.strokeLinecap "square"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M5.5 5.5C5.5 6.32843 4.82843 7 4 7C3.17157 7 2.5 6.32843 2.5 5.5C2.5 4.67157 3.17157 4 4 4C4.82843 4 5.5 4.67157 5.5 5.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M19.5 3.5C19.5 4.32843 18.8284 5 18 5C17.1716 5 16.5 4.32843 16.5 3.5C16.5 2.67157 17.1716 2 18 2C18.8284 2 19.5 2.67157 19.5 3.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M12.5 7.5C12.5 8.32843 11.8284 9 11 9C10.1716 9 9.5 8.32843 9.5 7.5C9.5 6.67157 10.1716 6 11 6C11.8284 6 12.5 6.67157 12.5 7.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M5.44336 5.91199L9.558 7.08762"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M12.3033 6.75547L16.6981 4.24414"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
...
document =
    Nri.Ui.Svg.V1.init "0 0 22 22"
        [ Svg.path
            [ Attributes.d "M7 16H15M7 12H11M12 1.5V2C12 4.82843 12 6.24264 12.8787 7.12132C13.7574 8 15.1716 8 18 8H18.5M19 9.6569V13C19 16.7712 19 18.6569 17.8284 19.8284C16.6569 21 14.7712 21 11 21C7.22876 21 5.34315 21 4.17157 19.8284C3 18.6569 3 16.7712 3 13V8.45584C3 5.21082 3 3.58831 3.88607 2.48933C4.06508 2.26731 4.26731 2.06508 4.48933 1.88607C5.58831 1 7.21082 1 10.4558 1C11.1614 1 11.5141 1 11.8372 1.11401C11.9044 1.13772 11.9702 1.165 12.0345 1.19575C12.3436 1.34355 12.593 1.593 13.0919 2.09188L17.8284 6.82843C18.4065 7.40649 18.6955 7.69552 18.8478 8.06306C19 8.4306 19 8.83935 19 9.6569Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
...
college =
    Nri.Ui.Svg.V1.init "0 0 22 22"
        [ Svg.path
            [ Attributes.d "M1 7.56907C1 6.37289 1.48238 5.63982 2.48063 5.08428L6.58987 2.79744C8.7431 1.59915 9.8197 1 11 1C12.1803 1 13.2569 1.59915 15.4101 2.79744L19.5194 5.08428C20.5176 5.63982 21 6.3729 21 7.56907C21 7.89343 21 8.05561 20.9646 8.18894C20.7785 8.88945 20.1437 9 19.5307 9H2.46928C1.85627 9 1.22152 8.88944 1.03542 8.18894C1 8.05561 1 7.89343 1 7.56907Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M10.9959 6H11.0049"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2.5"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M3 9V17.5M7 9V17.5"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M15 9V17.5M19 9V17.5"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
            []
        , Svg.path
            [ Attributes.d "M18 17.5H4C2.34315 17.5 1 18.8431 1 20.5C1 20.7761 1.22386 21 1.5 21H20.5C20.7761 21 21 20.7761 21 20.5C21 18.8431 19.6569 17.5 18 17.5Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.fill "none"
            ]
...
gradingAssistant =
    Nri.Ui.Svg.V1.init "0 0 22 22"
        [ Svg.path
            [ Attributes.d "M19.0331 2.30211C19.6805 1.97227 20.3717 2.66351 20.0419 3.31086L18.3525 6.62647C18.205 6.91597 18.2607 7.26754 18.4904 7.49729L21.1217 10.1286C21.6354 10.6423 21.1916 11.5133 20.474 11.3997L16.7987 10.8175C16.4777 10.7667 16.1606 10.9283 16.0131 11.2178L14.3237 14.5334C13.9939 15.1808 13.0283 15.0279 12.9147 14.3103L12.3326 10.6349C12.2817 10.314 12.03 10.0623 11.7091 10.0114L8.03374 9.42932C7.31614 9.31566 7.16321 8.35014 7.81057 8.0203L11.1262 6.33091C11.4157 6.1834 11.5773 5.86625 11.5264 5.54533L10.9443 1.86995C10.8307 1.15235 11.7017 0.70855 12.2154 1.22229L14.8467 3.85358C15.0765 4.08333 15.428 4.13901 15.7175 3.9915L19.0331 2.30211Z"
            , Attributes.fill "currentColor"
            ]
            []
        , Svg.path
            [ Attributes.d "M7.24264 12.0631C8.02369 11.282 9.29002 11.282 10.0711 12.0631C10.8521 12.8441 10.8521 14.1105 10.0711 14.8915L4.41421 20.5484C3.63317 21.3294 2.36683 21.3294 1.58579 20.5484C0.804738 19.7673 0.804738 18.501 1.58579 17.7199L7.24264 12.0631Z"
            , Attributes.fill "currentColor"
            ]
            []
        ]
...
manuallyGraded =
    Nri.Ui.Svg.V1.init "0 0 22 22"
        [ Svg.path
            [ Attributes.d "M6 6.99678H5.17647C3.67907 6.99678 2.93037 6.99678 2.46518 6.55782C2 6.11886 2 5.41236 2 3.99937C2 2.58638 2 1.87988 2.46518 1.44091C2.93037 1.00195 3.67907 1.00195 5.17647 1.00195H16.8235C18.3209 1.00195 19.0696 1.00195 19.5348 1.44091C20 1.87988 20 2.58638 20 3.99937C20 5.41236 20 6.11886 19.5348 6.55782C19.0696 6.99678 18.3209 6.99678 16.8235 6.99678H15.5"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "2"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M10.4932 21.4795C10.5536 21.5014 10.615 21.5206 10.6768 21.5391C10.6658 21.5358 10.6545 21.5337 10.6436 21.5303L10.4932 21.4795ZM11.001 3.75C11.967 3.75025 12.7501 4.53296 12.751 5.49902L12.7539 10.0508L13.1738 10.1182L15.2002 10.4463L15.2051 10.4473C16.0393 10.5741 16.6789 10.6721 17.1836 10.7832C17.6952 10.896 18.0891 11.0258 18.4229 11.2285C19.4684 11.8637 20.2499 12.8923 20.25 14.2656C20.25 14.9335 20.1346 15.4585 19.8838 16.2637L19.5869 17.1777C19.4314 17.6511 19.2678 18.1483 19.1016 18.5889C18.9741 18.9266 18.8541 19.2072 18.7451 19.4102L18.6396 19.5869C18.2057 20.2277 17.5909 20.7179 16.8789 20.9951L16.5684 21.1006C16.1941 21.2097 15.7819 21.2392 15.1768 21.2471L14.502 21.25H13.3037C12.1359 21.2504 11.4104 21.2443 10.7949 21.0537L10.5371 20.9609C10.4749 20.9349 10.4132 20.9072 10.3525 20.8779L10.1738 20.7852C9.6929 20.5203 9.30102 20.1219 8.78027 19.4961L8.20801 18.791L5.14844 14.9717C4.62053 14.3125 4.61652 13.3702 5.13965 12.707L5.26465 12.5654C5.91422 11.8978 6.97822 11.8391 7.69727 12.4639L7.69824 12.4648L7.70215 12.4678L9.25 13.8213V5.50098C9.25 4.53411 10.0341 3.75 11.001 3.75ZM8.38965 19.8096C8.49875 19.9409 8.60547 20.0634 8.70898 20.1797C8.69014 20.1585 8.67035 20.1379 8.65137 20.1162L8.38965 19.8096ZM6.99121 11.5742C7.1392 11.6045 7.28527 11.6494 7.42676 11.71L7.63477 11.8125C7.49831 11.7366 7.35621 11.6762 7.21094 11.6309L6.99121 11.5742ZM16.4824 10.1416C16.7826 10.1921 17.0515 10.242 17.292 10.2949C17.0515 10.242 16.7828 10.1921 16.4824 10.1416ZM8.85156 4.83203C8.82962 4.90258 8.81089 4.97452 8.7959 5.04785L8.76172 5.27051C8.7771 5.11906 8.80766 4.97211 8.85156 4.83105V4.83203ZM10.5469 3.2959C10.4739 3.31086 10.4023 3.32972 10.332 3.35156L10.125 3.42676C10.1921 3.39841 10.2609 3.37341 10.3311 3.35156L10.5469 3.2959ZM4.64648 15.1328C4.62133 15.0956 4.59893 15.0569 4.57617 15.0186C4.59893 15.0569 4.62134 15.0956 4.64648 15.1328Z"
            , Attributes.fill "currentColor"
            ]
            []
        ]
...
bookSearch =
    Nri.Ui.Svg.V1.init "0 0 17 16"
        [ Svg.path
            [ Attributes.d "M1.92099 3.03345L1.94561 12.3399C2.0387 14.05 3.21714 15.1731 4.83743 15.1731H11.4772C13.1005 15.1731 14.4165 13.8755 14.4165 12.2749V6.8995C14.4165 6.0198 14.1513 5.56224 13.8134 5.32473M13.8134 5.32473C13.4803 5.0905 13.0764 5.0703 12.7867 5.0703H4.28924C3.72692 5.0703 3.15489 4.93212 2.74565 4.55091C1.28811 3.19328 2.00987 1.68951 2.94643 1.01525C3.24181 0.802601 3.61556 0.750014 3.98097 0.750014L10.7067 0.750004C12.0339 0.750001 13.2645 1.61401 13.4391 2.92965C13.4474 2.99258 13.4546 3.05405 13.4605 3.11358C13.5389 3.90658 13.4605 5.15371 13.4605 5.15371L13.8134 5.32473Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "1.5"
            , Attributes.strokeLinecap "round"
            , Attributes.fill "none"
            ...
            []
        , Svg.path
            [ Attributes.d "M9.76831 11.7051L10.9666 12.9074"
            , Attributes.stroke "currentColor"
            , Attributes.strokeWidth "1.5"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            ...
            []
        , Svg.path
            [ Attributes.d "M10.2598 9.79664C10.2598 8.47303 9.18679 7.40002 7.86317 7.40002C6.53955 7.40002 5.46655 8.47303 5.46655 9.79664C5.46655 11.1203 6.53955 12.1933 7.86317 12.1933C9.18679 12.1933 10.2598 11.1203 10.2598 9.79664Z"
            , Attributes.stroke "currentColor"
            , Attributes.strokeLinecap "round"
            , Attributes.strokeLinejoin "round"
            , Attributes.fill "none"
