...
salSupportive =
    renderFullSal
        ...
        , legPaths =
            [ "M185.5,527.5c0.4,10.9,0.8,19.3,0.8,19.3s-14.9,9.7-16.5,15.9c-1.7,6.8,9.2,16.3,29,8\n\tc19.1-8,17.3-12.5,17.3-21.5s0-54.7,0-54.7l-30.2,4.2C185.9,498.7,185.1,516.6,185.5,527.5L185.5,527.5z"
            , "M261.9,525.1c0.5,10.9,0.9,19.3,0.9,19.3s15.7,8.3,17.8,14.4c2.3,6.6-7.8,17-28.2,10.5\n\tc-19.8-6.3-18.3-11-19.1-20c-0.8-9-4.7-54.5-4.7-54.5l30.4,1.6C259,496.5,261.4,514.3,261.9,525.1L261.9,525.1z"
            ]
        , sockPaths =
            [ "M196.3,546.5c0,0,6,0.8,12,0.6c5.7-0.2,9.7-1.8,9.7-1.8s0.5,11.6,0.3,12.1s-3.3,3.9-7.7,3.3\n\t\t\tS196.3,546.5,196.3,546.5L196.3,546.5z"
            , "M252.7,545c0,0-5.9,1.3-11.9,1.6s-9.8-1-9.8-1s0.5,11.6,0.7,12.1s3.6,3.6,7.9,2.6S252.7,545,252.7,545\n\t\t\tL252.7,545z"
            ]
        , shoePaths =
            [ "M221.6,558.7c0,0-6.7-6-13.4-7.5c-4.1-0.9-8.2-1.1-9.3-0.8c-0.4,0.1-0.8-0.3-0.7-0.7c0.6-2.1,1.6-6.5-0.4-7.4\n\t\t\tc-2.6-1.2-16.1,0.5-16.1,0.5v3.3c0,0-19.4,8.2-19.4,14.5s0.6,21,18.4,21.4S221.6,558.8,221.6,558.7L221.6,558.7z"
            , "M228.6,559.4c0,0,6.1-6.6,12.7-8.6c4-1.2,8.1-1.8,9.2-1.7c0.4,0.1,0.8-0.4,0.6-0.8c-0.8-2-2.2-6.3-0.3-7.4\n\t\t\tc2.5-1.5,16.1-0.8,16.1-0.8l0.3,3.3c0,0,20,6.5,20.5,12.8s1.2,21-16.5,22.9S228.6,559.4,228.6,559.4L228.6,559.4z"
            ]
        , shoeLacePaths =
        ...
        , shoeStripPaths =
            [ "M169.1,554.1c0,0,7.6-1.5,12.9,3.8c5.4,5.3,10.8,17.5,10.8,17.5s-8,9.4-15.9,6.3s-20.1-10.2-17.9-17.3\n\t\t\tC161.3,557.3,169.1,554.1,169.1,554.1z"
            , "M167.1,565.3c0,0,5.7,3.3,15.6,2.9c9.8-0.4,23.5-6.3,28.4-9.9s5.4-6.1,5.4-6.1l3.1,1.3c0,0,2.8,3.5-0.5,9.4\n\t\t\tc-3.3,5.8-12.1,11.8-22.2,12.8c-10.1,1.1-23.7,4.3-28.1,0.6C164.4,572.7,167.1,565.3,167.1,565.3L167.1,565.3z"
            , "M280.5,550.2c0,0-7.7-0.8-12.6,4.9c-4.9,5.7-9.3,18.4-9.3,18.4s8.8,8.7,16.3,4.9c7.5-3.8,19.1-11.9,16.3-18.8\n\t\t\tC288.5,552.7,280.5,550.2,280.5,550.2L280.5,550.2z"
            , "M283.5,561.2c0,0-5.4,3.8-15.3,4.2s-23.9-4.3-29.2-7.5c-5.3-3.2-5.9-5.6-5.9-5.6l-3,1.5c0,0-2.5,3.8,1.3,9.3\n\t\t\tc3.8,5.5,13.1,10.7,23.3,10.9c10.2,0.2,24,2.2,28-1.8S283.5,561.2,283.5,561.2L283.5,561.2z"
            ]
        , skirtPath = "M159.5,526.7c0,0,5.8-17,7.9-26.4c2-8.6,5.6-28,5.6-28s18.9,5.3,46.6,3.8c26.7-1.4,45.8-7.8,45.8-7.8\n\ts1.3,15.1,4.4,25.8c3.1,10.7,10.3,25.4,10.3,25.4s-18.5,11.6-60.4,12.7C178.6,533.1,159.5,526.7,159.5,526.7L159.5,526.7z"
        , headPaths =
            [ "M182.7,382.3l2.1-15.5c0,0-23.5-2.7-35.6-22.1c-12.1-19.4-9.2-46.2,10.3-66.7s46.7-33.9,89.4-22.2\n\tc42.7,11.7,46,52.9,45.7,61.1c-0.4,9.2-3.3,28.6-21.3,39.6C255.8,367,246,367.6,246,367.6l1.8,8.2c0,0-2,14.1-31.5,17.4\n\tC193.6,395.7,182.7,382.3,182.7,382.3L182.7,382.3z"
            , "M194.1,257c0,0-8-2.2-7-14.5c1.1-13.9,15.2-17.3,15.2-17.3s-0.9,5.4,4.3,12.2c7.2,9.5,30.6,14,42.2,18.4"
            ]
        , facePath = "M271.2,307.1c3,12.4,3.8,26.1-5.1,37.1c-8.6,10.7-23.4,17.4-52.8,15.6c-32.5-2-47.1-11.5-56.8-24.6\n\tc-5.4-7.3-3.7-21-1.5-27.7c7.4-23,27.8-41.9,59.7-41.9S265.6,283.6,271.2,307.1z"
        , eyeStreakPaths =
            [ "M240.6,290.8c0,0,11-0.1,20.9,7.2c9.9,7.3,13.8,15.6,13.8,15.6l-0.6,15.5c0,0-18.9-6.5-28.5-6.7\n\t\t\ts-10.4-0.4-10.4-0.4L240.6,290.8L240.6,290.8z"
            , "M185.3,284.4c0,0-14.6,2.9-24.5,10.2c-9.9,7.3-14.5,15.5-14.5,15.5l2.5,13c0,0,8.1-7.8,17.7-8.6\n\t\t\tc5.3-0.5,12.9-0.1,12.9-0.1L185.3,284.4L185.3,284.4z"
            ]
        , nosePath = "M192.9,324.7c-0.7-0.5-1.1-1.3-0.9-2.1c0.7-3.6,3.8-13.3,15.1-12.5c10.9,0.8,14.6,10.1,15.7,14\n\tc0.3,1-0.2,2.1-1.2,2.5c-2.9,1.2-9.5,3.3-16.8,2c-6.7-1.1-9.3-2.3-10.9-3.4L192.9,324.7z"
        , armPaths =
            [ "M111.3,367.7c0,0,11.8-17.7,39-24.1c6.7-1.6,6.6,6.5,5.9,10.8c-1.6,9.4-9.9,2.7-22.3,15.8\n\tc-6.3,6.7-11.7,8.1-11.7,8.1L111.3,367.7L111.3,367.7z"
            , "M313.9,469.1c0,0-25,9.5-34.7,9.6c-9.7,0.1-11.8-3.4-11.2-7.3c0.6-4,34.2-17.1,34.2-17.1L313.9,469.1\n\tL313.9,469.1z"
            ]
        , sweaterPaths =
            [ "M173.2,428.4c0,0-84.3,37.1-98.1,9.3c-14.6-29.5,38.7-76.6,38.7-76.6s1.9-8.5,5.7-7.1\n\tc6.2,2.3,13.9,11.6,15.1,16.1c1.1,4-2.3,3.6-5.6,5.9s-7.3,8.1-10.5,16.5c-5.6,15-8.2,16.8-6,19.5c2.5,3.1,36.4-21.3,56.1-23.4\n\tc23.1-2.4,32.3,0,32.3,0"
            , "M252.3,381.9c0,0,31.5-6.2,61,7.9c37.5,18,47,45.2,43.7,53.6c0,0-4.8,13.9-22.3,5.7\n\tc-15.5-7.2-21.8-14.9-35-20.1c-11.4-4.4-32.9-8.2-32.9-8.2"
            , "M173,472.3c0,0-10.1-6.7-11.9-24.4c-3.2-32.6,19.8-58.9,19.8-58.9s-3.9-8.4-1.1-10.3\n\tc3.5-2.4,11.9,4.7,35.2,3.7s34-8.1,36.4-7.5c3.9,1,0,10,0,10s24.7,19.5,26,48.9c1.4,31.3-12.3,34.5-12.3,34.5s-18.9,8-45.3,10\n\tC194.9,480.1,173,472.2,173,472.3L173,472.3z"
            , "M332.2,433.8c0,0-11.8,3.5-19.7,9.1c-3.3,2.3-9.3,7.9-12.9,8c-5.9,0.1-7.6,3.7-6.2,6.6c1.1,2.2,4.2,6.8,5,9.5\n\tc1.8,6.1,1.9,8.6,5.6,9.5s8.7-4.2,8.7-4.2s7-1.2,21.8-8.7s25.2-18.5,22.8-26.7"
            ]
        , shoulderFillPaths =
        ...
        , eyelidPaths =
            [ "M232,295.9c-0.7,0.4,0.1,0.6,0.3,0.4c1.6-0.8,4.8-1.7,9.8-0.5c6.8,1.7,9,6.4,9.6,8.1c0,0.1,0.2,0.1,0.2,0\n\tc0.1-1.7-0.1-6.5-3.1-9.8c-4.1-4.3-10.7-3.9-13.4-1.5C233.8,294,232.7,295.2,232,295.9L232,295.9z"
            , "M194.6,291.1c0.1,0.3-0.2,0.5-0.4,0.3c-1.4-1.2-4.2-2.8-9.4-2.9c-7,0-10.3,4-11.2,5.5c-0.1,0.1-0.2,0-0.2-0.1\n\tc0.4-1.7,1.6-6.3,5.5-8.8c5-3.2,11.3-1.1,13.3,1.9C193.4,288.8,194.1,290.1,194.6,291.1L194.6,291.1z"
            ]
        , mouthPath = "M198.9,332.3c4.2,1.7,8,3,12.5,2.3c1.5-0.1,2.9-0.4,4.5-0.7C211.4,338.7,202,338.7,198.9,332.3L198.9,332.3\n\tL198.9,332.3z"
        , eyebrowPaths =
        ...
        , pointerMagicPaths = []
        , fingerPaths =
            [ "M180.1,339.3c1.3-0.4,1.2-2-0.1-2.2c-6.2-0.6-16.7,0.2-21.8,2.3c-7.8,3.2-9.9,9.5-7.8,13.4\n\tc1.2,2.1,0.1-1.5,11.3-6.6C168.1,343.4,175.9,340.6,180.1,339.3L180.1,339.3z"
            , "M161.5,364.7c1.5,0.2,13.1-3.3,13.7-8.5c0.8-6.3-6.6-9.1-13.1-10c-9.8-1.2-14.2,2.1-13.1,6.1\n\tc0.8,3.1,2.4,3.6,15.2,2.7C174.4,354.4,156.3,364.2,161.5,364.7L161.5,364.7z"
            , "M158.3,368.4c1.3,0.1,11.1-3,11.7-7.7c0.7-5.7-5.6-8.3-11.1-9c-8.4-1.1-12,1.9-11.1,5.6\n\tc0.7,2.8,2,3.3,12.9,2.5C169.3,359,153.9,367.9,158.3,368.4L158.3,368.4z"
            , "M261.8,445.7c-0.6-0.9,0.6-2,1.6-1.4c4.6,2.9,11.1,9.2,13,13.4c2.9,6.3-0.1,11.6-4.4,13\n\tc-2.3,0.8,1.1-1-2.9-10.5C266.9,454.9,263.7,448.8,261.8,445.7L261.8,445.7z"
            , "M248,460.4c-1.2-0.3-1.1-1.9,0.1-2.1c5.7-1.2,15.3-1.4,20.1,0.2c7.1,2.4,9,8.4,7,12.5c-1.1,2.2,0-1.5-10.3-5.5\n\tC258.9,463.3,251.8,461.3,248,460.4L248,460.4z"
            , "M248.5,464.3c-0.9-0.7-0.3-1.5,0.8-1.8c5.9-1.4,15-0.5,20,2.6c6.1,3.8,4.9,9.7,1.1,11.7c-2,1-0.8-2.4-8.1-7.2\n\tC257.4,466.3,251.6,466.6,248.5,464.3L248.5,464.3z"
            ]
        , accentPaths =
            [ "M178.8,384.4c1.4,20,8.7,50.6,35,43.3c20.1-6.1,33.3-31.2,41.1-49.4c-5.9,19.9-19,45.8-40.2,52.3\n\tC186,438.1,177.8,406.5,178.8,384.4L178.8,384.4L178.8,384.4z"
