module Nri.Ui.Checkbox.V6 exposing
    ...
    , view, viewWithLabel, viewHighlightWithLabel
    , selectedFromBool
    )
...
@docs view, viewWithLabel, viewHighlightWithLabel
...
viewWithLabel model =
    buildCheckbox model Nothing <|
        \label -> Html.span [] [ Html.text label ]


{-| Shows a yellow highlighted checkbox and its label text
-}
viewHighlightWithLabel : Model msg -> Html.Html msg
viewHighlightWithLabel model =
    buildCheckbox model (Just Colors.sunshine) <|
        \label -> Html.span [] [ Html.text label ]


buildCheckbox : Model msg -> Maybe Css.Color -> (String -> Html.Html msg) -> Html.Html msg
buildCheckbox model backgroundColor labelView =
        ...
        , case model.theme of
            Square ->
                ...
                if model.disabled then
                    ...
                    viewEnabledLabel model labelView backgroundColor icon
            ...
            Locked ->
                if model.disabled then
                    ...
                    viewEnabledLabel model labelView Nothing checkboxLockOnInside
        ]
...
backgroundCss : Maybe Css.Color -> Style
