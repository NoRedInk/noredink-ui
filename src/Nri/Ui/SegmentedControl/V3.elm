module Nri.Ui.SegmentedControl.V3 exposing (Config, CssClasses, Icon, Option, styles, view)
...
{-| -}
view : Icon.Assets r -> Config a msg -> Html.Html msg
view assets config =
    config.options
        |> List.map
            (\option ->
...
viewIcon : Icon.Assets r -> Icon -> Html msg
